...
*/
function felicitarCumplean(nombre, regalo) {
  console.log(`A ${nombre} le regalaria un ${regalo}`);
}
felicitarCumplean("Jen", "Celular");
...
function esUnStringr(nameCh54) {
  console.log(`¿nameCh54 es de tipo string? ${typeof nameCh54 === 'string'}`);
}

  function esUnNumber(num) {
    console.log(`¿num es de tipo number? ${typeof num === 'number'}`);
  }
